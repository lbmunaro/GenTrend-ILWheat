...
# Script objective ----
# - Analyze genetic, nongenetic, and phenotypic trends
...
## Prepare dataset for trend analysis ----
dat_trends <- 
  blues |> # BLUEs from single-trial analysis
  mutate(check=ifelse(gen=='Kaskaskia',T,F), # Label check genotypes
...
# Save results ----
save(out_trends, file = 'data/Trends.RData')
